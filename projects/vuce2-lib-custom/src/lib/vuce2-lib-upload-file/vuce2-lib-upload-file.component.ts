...
import { Vuce2LibUploadFileService } from './vuce2-lib-upload-file.service';


import Swal from 'sweetalert2';
import { UFUtils, UF_MENSAJES } from './vuce2-lib-upload-file.utils';
import { IUploadConfig } from './vuce2-lib-upload-file.interface';
import { IStatusResponse } from '../interfaces';

@Component({
    selector: 'vuce2-lib-upload-file',
    templateUrl: './vuce2-lib-upload-file.component.html',
    styleUrls: ['./vuce2-lib-upload-file.component.scss']
})

export class Vuce2LibUploadFileComponent {
    form: FormGroup;
    progress: number = 0;
    ...
    constructor(
        ...
        public vuce2UploadFileService: Vuce2LibUploadFileService
    ) {
