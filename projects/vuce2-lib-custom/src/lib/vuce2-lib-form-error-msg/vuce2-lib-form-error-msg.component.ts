...
@Component({
  selector: 'vuce2-lib-form-error-msg',
  templateUrl: './vuce2-lib-form-error-msg.component.html',
  styleUrls: ['./vuce2-lib-form-error-msg.component.scss']
})
export class Vuce2LibFormErrorMsgComponent implements OnInit {
