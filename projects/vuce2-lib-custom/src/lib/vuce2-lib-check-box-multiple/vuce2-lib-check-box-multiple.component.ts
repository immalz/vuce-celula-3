...
@Component({
  selector: 'vuce2-lib-check-box-multiple',
  templateUrl: './vuce2-lib-check-box-multiple.component.html',
  styleUrls: ['./vuce2-lib-check-box-multiple.component.scss'],
  providers: [
    {
...
export class Vuce2LibCheckBoxMultipleComponent implements ControlValueAccessor {
