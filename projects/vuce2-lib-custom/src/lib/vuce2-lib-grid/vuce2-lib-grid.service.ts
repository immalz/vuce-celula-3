...
@Injectable()
export class Vuce2LibGridService {
    private stateChangedSource: BehaviorSubject<Vuce2LibGridService> = new BehaviorSubject<Vuce2LibGridService>(this);


    stateChanged$: Observable<Vuce2LibGridService>;
